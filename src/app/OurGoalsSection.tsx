...
const Card1 = ({
  ...
  return (
    <div className="bg-white p-10" id="goals">
      <Image
        src={imageSrc}
        alt="image"
      ...
      <h1 className="text-black md:text-4xl text-2xl pt-8 pb-6 font-bold">
        {title}
      </h1>
      ...
      <div className="flex items-center md:gap-10 gap-3">
        <div className="flex gap-1">
          <Link href={donationLink}>
            <div className="bg-yellow-500 text-black flex gap-1 px-4 py-2 font-semibold inline-flex items-center">
              Donate Now
        ...
        <div className="flex flex-col pt-4 items-start text-start">
          ...
          <p className="text-gray-700 leading-7 text-md">{donationText}</p>
        </div>
      </div>
    </div>
  );
